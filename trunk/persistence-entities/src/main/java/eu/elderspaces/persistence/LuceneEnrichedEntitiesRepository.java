...
public class LuceneEnrichedEntitiesRepository extends BaseLuceneRepository<String, String>
    ...
    @Inject
    public LuceneEnrichedEntitiesRepository(File directoryFile) throws IOException {
    
        super(new SimpleFSDirectory(directoryFile), new WhitespaceAnalyzer(Version.LUCENE_36));
    }
    
    public LuceneEnrichedEntitiesRepository() {
    ...
    public void switchToDirectory(File fileDirectory) throws RepositoryException {
    
        try {
            final IndexWriterConfig conf = new IndexWriterConfig(Version.LUCENE_36,
                    new WhitespaceAnalyzer(Version.LUCENE_36));
            writer = new IndexWriter(new SimpleFSDirectory(fileDirectory), conf);
