...
public class LuceneEntitiesRepository extends BaseLuceneRepository<String, Entity> implements
    ...
    private static Analyzer DEFAULT_ANALYZER = new WhitespaceAnalyzer(Version.LUCENE_36);
    private File directoryFile;
    
    @Inject
    public LuceneEntitiesRepository(File directoryFile) throws IOException {
    
        super(new SimpleFSDirectory(directoryFile), DEFAULT_ANALYZER);
        this.directoryFile = directoryFile;
    }
    
    public LuceneEntitiesRepository() {
    
        super(new RAMDirectory(), new WhitespaceAnalyzer(Version.LUCENE_36));
    ...
    public void reset() throws RepositoryException {
        ...
        try {
            ...
            throw new RepositoryException("Could not reset repository", e);
        }
        ...
        try {
            ...
            writer = new IndexWriter(new SimpleFSDirectory(directoryFile), conf);
