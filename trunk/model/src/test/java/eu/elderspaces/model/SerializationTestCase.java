...
public class SerializationTestCase {
    ...
    public void serializeActivity() throws JsonGenerationException, JsonMappingException,
        ...
        // final Person actor = new Person(PERSON_ID, PERSON_DISPLAY_NAME,
        // PERSON_THUMBNAIL_URL);
        // final Entity activityObject = new Activity(ACTIVITY_BODY,
        // ACTIVITY_TITLE, actor);
        // final ActivityStream activity = new ActivityStream(actor, VERB,
        // activityObject, null, PUBLISHED);
        //
